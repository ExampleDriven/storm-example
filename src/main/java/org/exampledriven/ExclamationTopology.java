...
public class ExclamationTopology {
    ...
    public static void main(String[] args) throws Exception {
        ...
        builder.setBolt(EXCLAIM, new MessageBolt("!!!"), 5).shuffleGrouping(WORD_SPOUT);
        builder.setBolt(HYPHEN, new MessageBolt("---"), 3).shuffleGrouping(EXCLAIM);
        ...
        if (args != null && args.length > 0) {
            ...
            //            ILocalCluster cluster = (ILocalCluster)Class.forName("backtype.storm.LocalCluster").newInstance();
