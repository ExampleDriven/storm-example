...
import org.exampledriven.stormexample.addmessage.singlestream.AddMessageTridentDRPCTopology;
import org.testng.annotations.Test;

import static org.testng.Assert.assertEquals;

public class AddMessageMultipleStreamTridentDRPCTopologyTest {
    ...
    public void testRemoteDrpc(String reach, String url) throws TException, DRPCExecutionException {
        ...
        String drpcResult = client.execute(AddMessageMultipleStreamTridentDRPCTopology.HANDLER_NAME, url);
    ...
    public void testLocalDrpc() throws Exception {
        ...
        cluster.submitTopology("test-topology", conf, AddMessageMultipleStreamTridentDRPCTopology.newLocalDRPCTridentTopology(drpc).build());
